...
@if ($statusMessage)
    <div
        ...
        <div id="status-toast"
            class="w-full animate-show-toast cursor-pointer rounded-lg border bg-white p-6 pr-8 text-stone-950 shadow-lg transition-all duration-500 data-[hide=true]:translate-x-full data-[hide=true]:opacity-0 data-[hide=true]:md:-translate-x-full">
            {{ $statusMessage }}
        </div>
    </div>
